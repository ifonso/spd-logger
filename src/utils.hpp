...
namespace utils {
    // É ideal usar constexpr, mas o clang não tanka

    const std::array<std::string_view, 5> info_messages = {
    ...
    const std::array<std::string_view, 5> warning_messages = {
    ...
    const std::array<std::string_view, 5> error_messages = {
